...
Отработал всё четко по заданию.
...
Сюжет, через сколько `--continue` прошли, ничего не понятно, но очень интересно. Проведу такой эксперемент на чистой ветке с простыми изменениями.
